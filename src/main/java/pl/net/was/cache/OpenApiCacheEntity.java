        ...
        boolean isFallback)
{
    ...
    public OpenApiCacheEntity(OpenAPI openApi,
            ...
            List<SecurityRequirement> securityRequirements)
    {
        this(openApi, tables, handles, errorPointers, resultsPointers, pathSecurityRequirements, securitySchemas, securityRequirements,
                false);
    }

    public OpenApiCacheEntity()
    {
        this(null, Map.of(), Map.of(), Map.of(), Map.of(), Map.of(), Map.of(), List.of(), true);
    }
}
